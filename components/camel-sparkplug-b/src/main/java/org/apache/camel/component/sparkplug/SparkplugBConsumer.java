...
public class SparkplugBConsumer extends DefaultConsumer {
    private final SparkplugBEndpoint endpoint;
    private final EventBusHelper eventBusHelper;

    private ExecutorService executorService;

    public SparkplugBConsumer(SparkplugBEndpoint endpoint, Processor processor) {
