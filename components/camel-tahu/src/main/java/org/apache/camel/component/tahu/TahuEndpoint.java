...
public abstract class TahuEndpoint extends DefaultEndpoint {

    @UriPath(description = "unused")
    private String unused;

    @UriParam
    protected final TahuConfiguration configuration;

    protected TahuEndpoint(String uri, TahuComponent component, TahuConfiguration configuration) {
