 ...
 */
@UriEndpoint(firstVersion = "4.0.0", scheme = TahuConstants.EDGE_NODE_SCHEME + "," + TahuConstants.DEVICE_SCHEME,
             title = "Tahu Edge Node,Tahu Device", extendsScheme = TahuConstants.BASE_SCHEME + "," + TahuConstants.BASE_SCHEME,
             syntax = TahuConstants.DEVICE_ENDPOINT_URI_SYNTAX,
             category = { Category.MESSAGING, Category.IOT, Category.MONITORING },
             headersClass = TahuConstants.class, producerOnly = true)
public class TahuEdgeNodeEndpoint extends TahuEndpoint implements HeaderFilterStrategyAware {
    ...
    TahuEdgeNodeEndpoint(String uri, TahuComponent component, TahuConfiguration configuration,
    ...
    public Consumer createConsumer(Processor processor) throws Exception {
        ...
        try {
            throw new FailedToCreateConsumerException(this, "Consumer creation is not supported for Edge Node endpoints");
        } finally {
