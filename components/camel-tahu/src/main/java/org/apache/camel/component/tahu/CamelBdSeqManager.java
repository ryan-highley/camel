...
public final class CamelBdSeqManager implements BdSeqManager {
    ...
    public long getNextDeathBdSeqNum() {
        ...
        try {
            ...
            LOG.trace(loggingMarker, "BdSeqManager getNextDeathBdSeqNum complete");
        }
    }

    @Override
    public void storeNextDeathBdSeqNum(long bdSeqNum) {
        LOG.trace(loggingMarker, "BdSeqManager storeNextDeathBdSeqNum called: bdSeqNum {}", bdSeqNum);
        try {
            ...
            LOG.trace(loggingMarker, "BdSeqManager storeNextDeathBdSeqNum complete");
        }
    }
