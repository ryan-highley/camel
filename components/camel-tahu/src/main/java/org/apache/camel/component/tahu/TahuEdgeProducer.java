...
public abstract class TahuEdgeProducer extends DefaultProducer {
    ...
    private TahuEdgeProducer(TahuEndpoint endpoint, EdgeNodeDescriptor edgeNodeDescriptor) {
        super(endpoint);
    ...
    private TahuEdgeClient createClient(TahuEndpoint endpoint, EdgeNodeDescriptor edgeNodeDescriptor) {
    ...
    static final class TahuEdgeNodeProducer extends TahuEdgeProducer {
        private TahuEdgeNodeProducer(TahuEndpoint endpoint, EdgeNodeDescriptor edgeNodeDescriptor) {
    ...
    static final class TahuEdgeDeviceProducer extends TahuEdgeProducer {
        private TahuEdgeDeviceProducer(TahuEndpoint endpoint, DeviceDescriptor deviceDescriptor) {
    ...
    static final class Builder {
        ...
        public Builder(TahuEndpoint endpoint) {
