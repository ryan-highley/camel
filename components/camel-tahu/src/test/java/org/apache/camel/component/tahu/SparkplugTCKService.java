...
public final class SparkplugTCKService implements TestService {
    ...
    static String getMqttHostAddress() {
    ...
    NotifyBuilder spTckResultMockNotify;
    NotifyBuilder spTckLogMockNotify;
    ...
    void initiateTckTest(String testConfig) throws MqttException {
    ...
    void resetTckTest() throws MqttException {
