...
public class TahuConfigurationTest extends CamelTestSupport {
    ...
    public void checkBasicEdgeNodeOptions() throws Exception {
        String uri
                = "tahu://Basic/EdgeNode?clientId=client1&primaryHostId=app1&deviceIds=D2&username=amq&password=amq&useAliases=true&rebirthDebounceDelay=2000&keepAliveTimeout=20";
